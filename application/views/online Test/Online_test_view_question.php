...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?= base_url();?>assets/css/Onine%20test/Online_test_view_question.css">
...
<div class="Test_Question_view" >
   ...
   header( "refresh:2;url=class_test");
    ...
    {?>
       <form id="results_form" action="<?=base_url();?>index.php/Online_test_result_controller/result" method="post" >
  ...
  function pager(wheref)
       {
        ...
        xmlhttp.onreadystatechange=function()
          ...
          document.getElementById("Next_pager").innerHTML=xmlhttp.responseText;
           ...
           xmlhttp.open("GET", "<?=base_url();?>index.php/Online_test_controller/quesation_view2/5/"+ wheref);
           xmlhttp.send(null); 
      }
      </script>
      <script type="text/javascript">
  ...
  function pager2()
       {
        ...
        xmlhttp.onreadystatechange=function()
          ...
          document.getElementById("Next_pager").innerHTML=xmlhttp.responseText;
           ...
           xmlhttp.open("GET", "<?=base_url();?>index.php/Online_test_controller/quesation_view2/1/1");
           xmlhttp.send(null); 
      }
      </script>
